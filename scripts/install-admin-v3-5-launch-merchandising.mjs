...
const payload=path.join(root,"dorokartes-admin-v3-5-payload");
...
const backup=path.join(path.dirname(root),`dorokartes-admin-backup-v3-5-${stamp}`);
...
console.log("Admin v3.5 Launch + Merchandising installed.");
