...
const payload=path.join(root,"dorokartes-admin-v3-8-1-payload");
...
const backup=path.join(path.dirname(root),`dorokartes-admin-backup-v3-8-1-${stamp}`);
...
console.log("Admin v3.8.1 balanced scale installed.");
console.log("Sidebar smaller; main UI significantly larger.");
