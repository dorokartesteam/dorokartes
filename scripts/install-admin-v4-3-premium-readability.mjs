...
const patchFile = "app/admin/patch-layout-v43.mjs";
...
console.log("Dorokartes Admin v4.3 Premium Readability installed.");
console.log("Sidebar sizing was intentionally left untouched.");
