...
const payload=path.join(root,"dorokartes-admin-v3-7-payload");
...
const backup=path.join(path.dirname(root),`dorokartes-admin-backup-v3-7-${stamp}`);
...
console.log("Admin v3.7 Media Center installed.");
